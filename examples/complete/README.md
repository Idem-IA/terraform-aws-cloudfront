...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_acm"></a> [acm](#module\_acm) | Idem-modules/acm/aws | ~> 4.0 |
| <a name="module_cloudfront"></a> [cloudfront](#module\_cloudfront) | ../../ | n/a |
| <a name="module_ec2"></a> [ec2](#module\_ec2) | Idem-modules/ec2-instance/aws | ~> 6.0 |
| <a name="module_lambda_function"></a> [lambda\_function](#module\_lambda\_function) | Idem-modules/lambda/aws | ~> 8.0 |
| <a name="module_log_bucket"></a> [log\_bucket](#module\_log\_bucket) | Idem-modules/s3-bucket/aws | ~> 5.0 |
| <a name="module_records"></a> [records](#module\_records) | Idem-modules/route53/aws//modules/records | ~> 5.0 |
| <a name="module_s3_one"></a> [s3\_one](#module\_s3\_one) | Idem-modules/s3-bucket/aws | ~> 5.0 |
